...
exports.SellersModule = SellersModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [sellers_service_1.SellersService, sellers_repository_1.SellersRepository],
        exports: [sellers_service_1.SellersService, sellers_repository_1.SellersRepository],
    })
], SellersModule);
